...
class Conjunto
{
    ...
    private:
        ...
        Nodo* buscarNodo(Nodo* r, const T& clave) const {
            Nodo* nodo = nullptr;
            if (r == nullptr){
                return nodo;
            }
            ...
            if(clave < r->valor){
                return buscarNodo(r->izq, clave);
            } else{
                return buscarNodo(r->der,clave);
            }
            return nodo;
        }

        Nodo* buscarNodoPadre(Nodo* r, const T& clave) const {
            ...
            // vamos por izq
                ...
                if (clave < r->valor){
                    return buscarNodoPadre(r->izq, clave);
                }else{
                    nodoPadre = r;
                }
            ...
            // vmaos por der
                ...
                if (clave > r->valor){
                    return buscarNodoPadre(r->der, clave);
                }else{
                    nodoPadre = r;
                }
